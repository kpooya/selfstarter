...
rails g scaffold address name:string user_id:integer address_additional:string city:string state:string country:string zip:string $force
 
rails g scaffold plan description:string price:decimal number:integer $force
 
rails g scaffold referral referrer_id:string referee_id:string $force

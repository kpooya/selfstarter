  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved referral as @referral" do
        ...
        post :create, {:referral => { "referrer_id" => "invalid value" }}, valid_session
        assigns(:referral).should be_a_new(Referral)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested referral" do
        ...
        Referral.any_instance.should_receive(:update_attributes).with({ "referrer_id" => "MyString" })
        put :update, {:id => referral.to_param, :referral => { "referrer_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the referral as @referral" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Referral.any_instance.stub(:save).and_return(false)
        put :update, {:id => referral.to_param, :referral => { "referrer_id" => "invalid value" }}, valid_session
        assigns(:referral).should eq(referral)
      end

  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pledge as @pledge" do
        ...
        post :create, {:pledge => { "email" => "invalid value" }}, valid_session
        assigns(:pledge).should be_a_new(Pledge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pledge" do
        ...
        Pledge.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => pledge.to_param, :pledge => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pledge as @pledge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pledge.any_instance.stub(:save).and_return(false)
        put :update, {:id => pledge.to_param, :pledge => { "email" => "invalid value" }}, valid_session
        assigns(:pledge).should eq(pledge)
      end

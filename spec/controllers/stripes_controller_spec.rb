...
describe StripesController do
  ...
  describe "GET index" do
    it "assigns all stripes as @stripes" do
      ...
      assigns(:stripes).should eq([stripe])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested stripe as @stripe" do
      ...
      assigns(:stripe).should eq(stripe)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new stripe as @stripe" do
      ...
      assigns(:stripe).should be_a_new(Stripe)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created stripe as @stripe" do
        post :create, {:stripe => valid_attributes}, valid_session
        assigns(:stripe).should be_a(Stripe)
        assigns(:stripe).should be_persisted
      end

      it "redirects to the created stripe" do
        post :create, {:stripe => valid_attributes}, valid_session
        response.should redirect_to(Stripe.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stripe as @stripe" do
        ...
        Stripe.any_instance.stub(:save).and_return(false)
        post :create, {:stripe => { "email" => "invalid value" }}, valid_session
        assigns(:stripe).should be_a_new(Stripe)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stripe" do
        stripe = Stripe.create! valid_attributes
        # Assuming there are no other stripes in the database, this
        # specifies that the Stripe created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Stripe.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => stripe.to_param, :stripe => { "email" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the stripe" do
        stripe = Stripe.create! valid_attributes
        put :update, {:id => stripe.to_param, :stripe => valid_attributes}, valid_session
        response.should redirect_to(stripe)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the stripe as @stripe" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Stripe.any_instance.stub(:save).and_return(false)
        put :update, {:id => stripe.to_param, :stripe => { "email" => "invalid value" }}, valid_session
        assigns(:stripe).should eq(stripe)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the stripes list" do
      stripe = Stripe.create! valid_attributes
      delete :destroy, {:id => stripe.to_param}, valid_session
      response.should redirect_to(stripes_url)
    end
  end
